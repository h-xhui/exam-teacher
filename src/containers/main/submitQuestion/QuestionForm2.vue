    ...
    <el-form :model="questionForm" :rules="questionRules" ref="questionFormRef" label-width="80px">
      ...
      <el-form-item label="选项A" prop="A">
        <el-input v-model="questionForm.a">
          <el-checkbox v-model="answerForm.answer" label="A" slot="append">正确答案</el-checkbox>
        </el-input>
      ...
      <el-form-item label="选项B" prop="B">
        <el-input v-model="questionForm.b">
          <el-checkbox v-model="answerForm.answer" label="B" slot="append">正确答案</el-checkbox>
        </el-input>
      ...
      <el-form-item label="选项C" prop="C">
        <el-input v-model="questionForm.c">
          <el-checkbox v-model="answerForm.answer" label="C" slot="append">正确答案</el-checkbox>
        </el-input>
      ...
      <el-form-item label="选项D" prop="D">
        <el-input v-model="questionForm.d">
          <el-checkbox v-model="answerForm.answer" label="D" slot="append">正确答案</el-checkbox>
        </el-input>
